      ...
      const content: ContentItem[] = [
        {
          path: "/note-a",
          type: "note",
          body: { type: "minimark", value: [["p", {}, ["a", { href: "/note-b" }, "B"]]] },
        },
      ...
      const content: ContentItem[] = [
        {
          path: "/my-map",
          type: "map",
          body: { type: "minimark", value: [["p", {}, ["a", { href: "/my-map" }, "Self"]]] },
        },
      ];
      const nodes: GraphNode[] = [
        {
      ...
      const content: ContentItem[] = [
        {
          path: "/my-map",
          type: "map",
          body: { type: "minimark", value: [["p", {}, ["a", { href: "/ghost" }, "Ghost"]]] },
        },
      ];
      const nodes: GraphNode[] = [
        {
      ...
      const content: ContentItem[] = [
        {
          path: "/map-one",
          type: "map",
          body: { type: "minimark", value: [["p", {}, ["a", { href: "/note-a" }, "A"]]] },
        },
        {
          path: "/map-two",
          type: "map",
