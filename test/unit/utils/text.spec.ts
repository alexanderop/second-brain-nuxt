...
describe("getSnippet", () => {
  const longContent =
    "This is the beginning of a very long piece of content that discusses the Atomic Habits book and how it relates to productivity and personal development in modern life.";
