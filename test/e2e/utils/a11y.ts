...
export async function checkA11y(page: Page, options?: A11yOptions) {
  ...
  await page.addInitScript(() => {
    // oxlint-disable-next-line @typescript-eslint/consistent-type-assertions -- Window type augmentation for Vue DevTools
    delete (window as Window & { __VUE_DEVTOOLS_GLOBAL_HOOK__?: unknown })
