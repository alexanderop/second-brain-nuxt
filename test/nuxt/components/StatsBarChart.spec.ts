...
import StatsBarChart from "~/components/StatsBarChart.client.vue";
import { createBarChartData, createSingleItemData } from "../../fixtures/chartFactory";
import type { BarChartDataItem } from "../../fixtures/chartFactory";
...
async function renderBarChart(props: {
