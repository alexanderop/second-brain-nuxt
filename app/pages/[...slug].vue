  ...
  >
    ...
    <article class="lg:col-span-8 xl:col-span-9">
      <ContentHeader
        ...
        :podcast="typedPodcast ?? undefined"
        :newsletter="typedNewsletter ?? undefined"
      ...
      <div
        v-if="page.summary"
        class="mb-8 p-5 bg-[var(--ui-bg-elevated)] rounded-xl border border-[var(--ui-border)]"
      >
      ...
      <section
        v-if="page.notes"
        class="mb-8 p-5 border-l-4 border-[var(--ui-primary)] bg-[var(--ui-bg-elevated)]/50 rounded-r-lg"
      >
        <h2 class="text-sm font-semibold mb-2 text-[var(--ui-primary)]">My Notes</h2>
    ...
    <aside
      v-if="tocLinks.length > 0 && !isFocusMode && isTocVisible"
      class="hidden lg:block lg:col-span-4 xl:col-span-3"
    >
