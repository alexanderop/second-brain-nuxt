...
<template>
  <UModal
    v-model:open="open"
    title="Select Author"
    description="This note has multiple authors. Select one to open their page."
  >
    <template #content>
      <div class="p-6">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-lg font-semibold">Select Author</h2>
          <UButton
            icon="i-lucide-x"
            variant="ghost"
            color="neutral"
        ...
        <div
          class="mt-4 pt-4 border-t border-[var(--ui-border)] text-xs text-[var(--ui-text-muted)]"
        >
          <span class="mr-4"
            ><kbd class="px-1.5 py-0.5 bg-[var(--ui-bg-elevated)] rounded">j</kbd> /
            <kbd class="px-1.5 py-0.5 bg-[var(--ui-bg-elevated)] rounded">k</kbd> to navigate</span
          >
          <span
            ><kbd class="px-1.5 py-0.5 bg-[var(--ui-bg-elevated)] rounded">enter</kbd> to open</span
          >
        </div>
      </div>
    </template>
